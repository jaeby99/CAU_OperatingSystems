...
thread_init (void) 
{
  ...
  init_thread (initial_thread, "main", PRI_DEFAULT);							// 스레드를 초기화 시킬때 block상태로 초기화한다
...
/* Creates a new kernel thread named NAME with the given initial
   ...
   scheduled before thread_create() returns.  It could even exit		스레드가 만들어지기도 전에 스케줄되거나 혹은 중료될 수도 있으니 동기화를 해서 순서를 정해라
